...
public class BusFactoryTest {
  ...
  public void testConstructorNightStrategy() {
    BusFactory nightBusFactory = new BusFactory(storageFacility, new Counter(), 20);
    assertTrue(nightBusFactory.getGenerationStrategy() instanceof BusStrategyNight);
  }

  /**
   * Testing if a SmallBus is returned to the storage facility.
   */
  @Test
  public void testReturnVehicleSmallBus() {
    ...
    Bus testBus = new SmallBus(1, new Line(10000, "testLine", "BUS", testRouteOut, testRouteIn,
        new Issue()), SmallBus.CAPACITY, SmallBus.SPEED);
