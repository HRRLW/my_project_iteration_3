...
public class BusFactory implements VehicleFactory {
  ...
  public Vehicle generateVehicle(Line line) {
    ...
    if (typeOfVehicle != null && typeOfVehicle.equals(SmallBus.SMALL_BUS_VEHICLE)) {
       generatedVehicle = new SmallBusColorDecorator(new SmallBus(counter.getSmallBusIdCounterAndIncrement(),
      ...
      storageFacility.decrementSmallBusesNum();
       ...
       generatedVehicle = new LargeBusColorDecorator(new LargeBus(counter.getLargeBusIdCounterAndIncrement(), line,
